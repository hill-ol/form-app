...
export default function SleepLogSheet({ onClose }: Props) {
    ...
    return (
        <CalendarPopupPortal onClose={onClose}>
            ...
            <p className="font-black mb-1" style={{ fontSize: '17px' }}>Log last night&apos;s sleep</p>
            ...
            <div className="mb-5">
                ...
                <div className="flex items-center gap-3">
                    ...
                    />
                    <span className="font-black" style={{ fontSize: '24px', color: 'var(--pink)', minWidth: '52px' }}>
            {hours.toFixed(1)}h
          </span>
                </div>
                ...
                <div className="flex gap-2">
                    {([1, 2, 3, 4, 5] as const).map(level => (
                        <button key={level}
                                ...
                                style={{
                                    border: mood === level ? '2px solid var(--pink)' : '1.5px solid var(--border)',
